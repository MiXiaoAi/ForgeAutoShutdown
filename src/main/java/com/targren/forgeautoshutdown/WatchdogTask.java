...
public class WatchdogTask extends TimerTask
{
    ...
    public static void create(MinecraftServer server)
    {
        if (INSTANCE != null)
        {
            LOGGER.warn("WatchdogTask already exists, stopping old instance");
            stop();
        }
        ...
        TIMER = new Timer("ForgeAutoShutdown watchdog", true); // Set as daemon thread
    ...
    /** Stops the watchdog task and cleans up resources */
    public static void stop()
    {
        ...
        LOGGER.debug("WatchdogTask stopped");
    }
